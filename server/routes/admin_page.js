...
function fhirToComposition(fhirMessage) {
  let composition = {
    "items.0.0.items.0.items.0.value": "entry.2.resource.gender",
    ...
    "items.0.0.items.0.items.2.items.0.value": "entry.2.resource.address.0.text",
    "items.0.0.items.0.items.2.items.1.value": "entry.2.resource.address.0.city",
    "items.0.0.items.0.items.2.items.2.value": "entry.2.resource.address.0.district",
    "items.0.0.items.0.items.2.items.3.value": "entry.2.resource.address.0.postalcode",
    "items.0.0.items.0.items.2.items.4.value": "entry.2.resource.address.0.country",
    "items.0.1.items.0.value": "entry.3.entry.id,entry.3.entry.identifier.0.value",
    ...
    "items.0.1.items.3.items.1.value": "entry.3.entry.participant.type",
    "items.0.1.items.4.value.date": "entry.3.entry.period.end.date",
    "items.0.1.items.4.value.time": "entry.3.entry.period.end.time",
    "items.0.1.items.5.value": "entry.3.entry.hospitalization.dischargeDisposition",
    "items.0.1.items.6.items.0.value": "entry.4.name",
    "items.0.1.items.6.items.1.value": "entry.4.identifier",
    "items.0.2.items.0.value": "entry.5.entry.substance",
    "items.0.2.items.1.value": "entry.5.entry.criticality",
    "items.0.2.items.2.items.0.value": "entry.5.entry.verificationStatus",
    "items.0.3.items.0.value": "entry.6.entry.comment",
    "items.0.4.items.0.value": "entry.7.entry.reason",
    "items.0.4.items.1.value": "entry.7.entry.description",
    "items.0.4.items.3.items.0.value": "entry.7.entry.participant.name",
    "items.0.5.items.0.value": "entry.8.entry.reason",
    "items.0.5.items.1.value": "entry.8.entry.description",
    "items.0.5.items.3.items.0.value": "entry.8.entry.participant.name",
    "items.0.6.items.0.value": "entry.9.entry.medication",
    ...
    "items.0.9.items.0.value": "entry.12.entry.list",
  };
